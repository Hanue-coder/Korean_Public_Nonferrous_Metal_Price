...
<!-- AUTO-GENERATED by generate_dashboard.py — DO NOT EDIT dashboard.html directly. Edit the template in generate_dashboard.py instead. -->
<html lang="ko">
<head>
<meta charset="UTF-8">
...
<style>
  *, *::before, *::after {{ box-sizing: border-box; margin: 0; padding: 0; }}
  ...
  th:first-child {{ text-align: center; width: 10%; }}
  td {{ padding: 7px 10px; text-align: right; border-bottom: 1px solid #EBEEF3; white-space: nowrap; }}
  td:first-child {{ text-align: center; font-weight: 600; color: #333333; }}
